          ...
          Results.prototype.bind = function(container, $container) {
            ...
            if ($2.fn.mousewheel) {
              this.$results.on("mousewheel", function(e2) {
                ...
                var bottom = self.$results.get(0).scrollHeight - top + e2.deltaY;
                var isAtTop = e2.deltaY > 0 && top - e2.deltaY <= 0;
                var isAtBottom = e2.deltaY < 0 && bottom <= self.$results.height();
                if (isAtTop) {
                  self.$results.scrollTop(0);
                  e2.preventDefault();
                  e2.stopPropagation();
...
import "E:/laragon/www/PizzaPitsa/node_modules/select2/dist/css/select2.min.css";
function t(e2, t2, n2) {
...
function r(e2) {
  for (var r2 = 1; r2 < arguments.length; r2++) {
    var o2 = null != arguments[r2] ? arguments[r2] : {};
    r2 % 2 ? n(Object(o2), true).forEach(function(n2) {
      t(e2, n2, o2[n2]);
    }) : Object.getOwnPropertyDescriptors ? Object.defineProperties(e2, Object.getOwnPropertyDescriptors(o2)) : n(Object(o2)).forEach(function(t2) {
...
function s(e2, t2, n2, r2, o2, i2, s2, c2, l2, a2) {
  "boolean" != typeof s2 && (l2 = c2, c2 = s2, s2 = false);
  const u2 = "function" == typeof n2 ? n2.options : n2;
  let f;
  if (e2 && e2.render && (u2.render = e2.render, u2.staticRenderFns = e2.staticRenderFns, u2._compiled = true, o2 && (u2.functional = true)), r2 && (u2._scopeId = r2), i2 ? (f = function(e3) {
    (e3 = e3 || this.$vnode && this.$vnode.ssrContext || this.parent && this.parent.$vnode && this.parent.$vnode.ssrContext) || "undefined" == typeof __VUE_SSR_CONTEXT__ || (e3 = __VUE_SSR_CONTEXT__), t2 && t2.call(this, l2(e3)), e3 && e3._registeredComponents && e3._registeredComponents.add(i2);
  }, u2._ssrRegister = f) : t2 && (f = s2 ? function(e3) {
    t2.call(this, a2(e3, this.$root.$options.shadowRoot));
  } : function(e3) {
    t2.call(this, c2(e3));
  }), f)
    if (u2.functional) {
      const e3 = u2.render;
      u2.render = function(t3, n3) {
        return f.call(n3), e3(t3, n3);
      };
    } else {
      const e3 = u2.beforeCreate;
      u2.beforeCreate = e3 ? [].concat(e3, f) : [f];
    }
  return n2;
}
var c = s({ render: function() {
  var e2 = this.$createElement, t2 = this._self._c || e2;
  return t2("div", [t2("select", { staticClass: "form-control", attrs: { id: this.id, name: this.name, disabled: this.disabled, required: this.required } })]);
}, staticRenderFns: [] }, void 0, { name: "Select2", data: function() {
  return { select2: null };
}, model: { event: "change", prop: "value" }, props: { id: { type: String, default: "" }, name: { type: String, default: "" }, placeholder: { type: String, default: "" }, options: { type: Array, default: function() {
  return [];
} }, disabled: { type: Boolean, default: false }, required: { type: Boolean, default: false }, settings: { type: Object, default: function() {
} }, value: null }, watch: { options: function(e2) {
  this.setOption(e2);
}, value: function(e2) {
  this.setValue(e2);
} }, methods: { setOption: function() {
  var e2 = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : [];
  this.select2.empty(), this.select2.select2(r(r({ placeholder: this.placeholder }, this.settings), {}, { data: e2 })), this.setValue(this.value);
}, setValue: function(e2) {
  e2 instanceof Array ? this.select2.val(o(e2)) : this.select2.val([e2]), this.select2.trigger("change");
} }, mounted: function() {
  var t2 = this;
  this.select2 = (0, import_jquery.default)(this.$el).find("select").select2(r(r({ placeholder: this.placeholder }, this.settings), {}, { data: this.options })).on("select2:select select2:unselect", function(e2) {
    t2.$emit("change", t2.select2.val()), t2.$emit("select", e2.params.data);
  }).on("select2:closing", function(e2) {
    t2.$emit("closing", e2);
  }).on("select2:close", function(e2) {
    t2.$emit("close", e2);
  }).on("select2:opening", function(e2) {
    t2.$emit("opening", e2);
  }).on("select2:open", function(e2) {
    t2.$emit("open", e2);
  }).on("select2:clearing", function(e2) {
    t2.$emit("clearing", e2);
  }).on("select2:clear", function(e2) {
    t2.$emit("clear", e2);
...
function l(e2) {
  l.installed || (l.installed = true, e2.component("MyComponent", c));
}
var a = { install: l };
var u = null;
"undefined" != typeof window ? u = window.Vue : "undefined" != typeof global && (u = global.Vue), u && u.use(a);
var Select2_esm_default = c;
export {
  Select2_esm_default as default,
  l as install
};
...
select2/dist/js/select2.full.js:
   ...
   *)
*/
//# sourceMappingURL=v-select2-component.js.map
