            ...
            <header class="sc-1of5u0p-0 guZDAe container">
                <div class="left">
                    ...
                    <div>
                        ...
                        </div>4.85 <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" class="sc-1ohwd10-3 bjNpWs">
                            <defs>
                    ...
                    <div class="contacts-phone__number">
                        <a class="contacts-phone__number-link" href="tel:6299209">6 299 209</a>
                    </div>
                    <div class="contacts-phone__description">
                        <span class="contacts-phone__description-text">Call</span>
                    </div>
                    </div>
                </div>
                <div class="right">
