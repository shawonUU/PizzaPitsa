                            ...
                            <aside class="axil-dashboard-aside">
                                <nav class="axil-dashboard-nav">
                                    <div class="nav nav-tabs" role="tablist">
                                        ...
                                        <a class="nav-item nav-link" href="sign-in.html" aria-selected="false" tabindex="-1" role="tab"><i class="fal fa-sign-out"></i>Logout</a>
                                    </div>
                                </nav>
                            </aside>
                        </div>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane fade active show" id="nav-dashboard" role="tabpanel">
                                    <div class="axil-dashboard-overview">
                                        <div class="welcome-text">{{ isAuth.name }} (not <span>{{ isAuth.name }}?</span> <a href="sign-in.html">Log Out</a>)</div>
