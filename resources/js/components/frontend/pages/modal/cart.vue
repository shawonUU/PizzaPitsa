                          ...
                          <div class="p-2 bd-highlight w-100">
                            ...
                            >
                              ...
                              >
                                <template v-if="toping">
                                  ...
                                  >
                                  <span v-if="topingId != item.options.length-1"
                                    >,</span
                                  >
                                </template>
                              </template>
                            ...
                            >
                              ...
                              >
                                <template v-if="toping">
                                  ...
                                  >
                                  <span v-if="topingId != item.topings.length-1"
                                    >,</span
                                  >
                                </template>
                              </template>
                            ...
                            >
                              ...
                              >
                                ...
                                >
                                <span v-if="tagid != item.removedTags.length-1"
                                  >,</span
                                >
                              </template>
                            </p>
            ...
            <div class="input-group" style="cursor: pointer">
              ...
              <span
                style="
                  ...
                  text-align: center;
                "
                >Minimal order delivery value is 12{{ baseCurrencySymbol }}</span
              >
            </div>
          </div>
          <div class="col-12 col-md-6 mt-5 mb-3">
...
import DeliveryPlace from './deliveryPlace.vue';
