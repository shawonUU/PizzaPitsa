                        ...
                        <div class="row gy-4">
                            ...
                            <form action="{{ route('products.update',$product->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row">
                                    ...
                                    <div class="card text-center" style="padding : 0; margin: 10px">
                                        <div class="card-header" style="background-color: rgb(149 148 144 / 40%);">
                                            <h3>Edit Product</h3>
                                        </div>
                                        <div class="card-body shadow-lg" style="background-color: rgb(0 0 0 / 3%);">
                                            <div class="row">
                                            ...
                                            <div class="row mt-2">
                                                <div style="max-width: 500px;">
                                                        ...
                                                        <div class="row">
                                                            <div class="col mt-3">
                                                                <div class="d-flex justify-content-end">
                                                                    <button type="button" class="btn btn-sm btn-primary mr-1" onclick="addNewItem()">Add One</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                ...
                                <div class="card-body shadow-lg" style="background-color: rgb(0 0 0 / 3%);">
                                    <div class="row ">
                                        <div class="col">
                                            ...
                                            <div class="card pt-0">
                                                <div class="card-header align-items-center d-flex" style="background-color: rgb(0 0 0 / 3%);">
                                                    <h4 class="card-title mb-0 flex-grow-1">Product Size List</h4>
                                                </div>
                        
                                                <div class="card-body" style="background-color: rgb(0 0 0 / 3%);">
...
<script>
    ...
    var html = `
        <div class="row mt-2" id="item${O_ITEM_NUMBER}" data-item="${O_ITEM_NUMBER}">
            ...
            <div class="col-5 mb-3">
                <label for="name" class="form-label">Free Qty</label>
                <input class="form-control" type="number" name="freeQty[]" id="freeQty${O_ITEM_NUMBER}" value="0" required>
            </div>
