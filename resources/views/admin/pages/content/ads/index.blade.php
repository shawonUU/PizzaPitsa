                    ...
                    <div class="card p-3">
                        ...
                        <div class="card-body">
                            <table class="table table-stripedw-100" id="dataTbl">
                                ...
                                <tbody>                                 
                                    <tr>                                     
                                        <td><img style="width:100px; border-radius:5px" src="{{ asset('frontend/assets/images/ads/'.$ad->first_ad) }}" alt=""></td>                                                                            
                                        <td><img style="width:100px; border-radius:5px" src="{{ asset('frontend/assets/images/ads/'.$ad->second_ad) }}" alt=""></td>                                                                            
                                        <td>
