            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown topbar-head-dropdown ms-1 header-item" id="notificationDropdown">
                    <button type="button" class="btn btn-icon btn-topbar material-shadow-none btn-ghost-secondary rounded-circle" id="page-header-notifications-dropdown" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-haspopup="true" aria-expanded="false">
                        ...
                        <span id="unSeenNotifications" class=" {{ unSeenNotifications() == 0 ? 'd-none' : '' }} position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger unSeenNotifications">{{ unSeenNotifications() }}<span class="visually-hidden">unread messages</span></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end p-0" aria-labelledby="page-header-notifications-dropdown">
                            ...
                            <div class="p-3">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto dropdown-tabs">
                                        <span class="badge bg-light text-body fs-13"> <span class="unSeenNotifications">{{ unSeenNotifications() }}</span> New</span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <ul class="nav nav-tabs dropdown-tabs nav-tabs-custom" data-dropdown-tabs="true" id="notificationItemsTab" role="tablist">
                                    <li class="nav-item waves-effect waves-light">
                                        <a class="nav-link active" data-bs-toggle="tab" href="#all-noti-tab" role="tab" aria-selected="true">
                                            All (<span class="unSeenNotifications">{{ unSeenNotifications() }}</span>)
                                        </a>
                                    </li>
                                    <li class="nav-item waves-effect waves-light">
                        ...
                        <div class="tab-content position-relative" id="notificationItemsTabContentjh">
                            <div class="tab-pane fade show active py-2 ps-2" id="all-noti-tab" role="tabpanel">
                                <div data-simplebar style="max-height: 300px;" class="pe-2" id="notiFicationContainer">
                                    ...
                                    @foreach (getNotifications() as $notification)
                                        <div class="text-reset notification-item d-block dropdown-item position-relative" >
                                            <div class="d-flex">
                                                ...
                                                <div class="flex-grow-1">
                                                    <a href="javascript:void(0)" onclick="updateNotification({{ $notification->id }}, '{{ $notification->url }}')" class="stretched-link">
